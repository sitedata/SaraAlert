    ...
    return (
      <React.Fragment>
        ...
        <ButtonGroup className="float-right mb-4 mr-2">
          <Button variant={this.props.workflow === 'exposure' ? 'primary' : 'outline-primary'} href={`${window.BASE_PATH}/public_health`}>            <i className="fas fa-people-arrows"></i> Exposure Monitoring{' '}
